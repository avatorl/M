...
//      fxOpenAI("Translate this text into French, Italian, and German. Text to translate:", [Text])
(user as text, optional userData as text) =>
    let
        // CONFIGURATION ==================================================================================
        // Replace the API key below with your actual API key
        _api_key = "sk-proj-...SR8A",
        // Determine the model to use, for example: "gpt-4o-mini", "gpt-4o", "o1-mini"
        _model = "gpt-4o-mini",
        // Prepare user prompt: concatenate userData with user
        _user = user & " " & (userData ?? ""),
        // Determine the system message, for example: "You're a helpful assistant"
        _system = "You're a helpful assistant",
        ...
        //      Function call: fxOpenAI("Translate this text into French, Italian, and German. Text to translate:",[Text]), where [Text] = "I have an apple and 2 oranges"
        ...
        Result = [
            ...
            // "stop" - the API returned the full chat completion generated by the model without running into any limits
            // "length" - the conversation was too long for the context window
            // "content_filter" - the content was filtered due to policy violations
            FinishReason = reason,
